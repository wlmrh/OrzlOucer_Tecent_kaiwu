...
from agent_sarsa.feature.definition import (
    sample_process,
    reward_shaping,
)
import time
        ...
        for episode in range(EPISODES):
            ...
            while not done:
                ...
                if terminated:
                    ...
                    next_act_data, model_version = agent.predict(list_obs_data=[_obs_data])
                    next_act_data = next_act_data[0]

                    next_act = agent.action_process(next_act_data)
