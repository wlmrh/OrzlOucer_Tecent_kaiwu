...
class Config:
    ...
    # Total action space dimension (movement + talent)
    # 总动作空间维度（移动 + 闪现）
    DIM_OF_TOTAL_ACTION = DIM_OF_ACTION_DIRECTION + DIM_OF_TALENT
    ...
    SAMPLE_DIM = 2 * (DIM_OF_OBSERVATION + DIM_OF_TOTAL_ACTION) + 4
